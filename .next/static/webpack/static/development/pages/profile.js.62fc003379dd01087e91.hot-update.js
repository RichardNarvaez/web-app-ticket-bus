...
function (_React$Component) {
  ...
  function Profile() {
    ...
    console.log(_data_reservas_json__WEBPACK_IMPORTED_MODULE_6__);
    _this.state = {
      data: _data_reservas_json__WEBPACK_IMPORTED_MODULE_6__
    }; // fetch(Data)
    //     .then((res) => res.json())
    //     .then((data) => {
  ...
  _createClass(Profile, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        __self: this
      }, "Aqui aparecen los viajes que has realizado y los pendientes.")), this.state.data.map(function (item, i) {
        //console.log('test', item);
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_cajaInfo__WEBPACK_IMPORTED_MODULE_4__["default"], {
          data: item,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 60
...
//# sourceMappingURL=profile.js.62fc003379dd01087e91.hot-update.js.map